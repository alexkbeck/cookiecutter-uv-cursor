...
Report bugs at <https://github.com/alexkbeck/cookiecutter-uv-cursor/issues
...
The best way to send feedback is to file an issue at <https://github.com/alexkbeck/cookiecutter-uv-cursor/issues.
...
Ready to contribute? Here\'s how to set up `cookiecutter-uv-cursor` for local development.
Please note this documentation assumes you already have `uv` and `git` installed and ready to go.

1. Fork the `cookiecutter-uv-cursor` repo on GitHub.

2. Clone your fork locally:

```bash
cd <directory_in_which_repo_should_be_created
git clone git@github.com:YOUR_NAME/cookiecutter-uv-cursor.git
```
